...
namespace Learnaptic.Api.Migrations
{
    ...
    [Migration("20260808052702_AddUserDependency")]
    partial class AddUserDependency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learnaptic.Api.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Learnaptic.Api.Models.StudySet", b =>
                {
                    b.HasOne("Learnaptic.Api.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Learnaptic.Api.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
